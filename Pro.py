...
RfuBot=[lineMID]
Family=["u031d2a5d136c29549df4a6eb5d52b31f",lineMID]
admin=['u031d2a5d136c29549df4a6eb5d52b31f',lineMID]
...
║»══════════════
║»» บอทป้องกันระบบใหม่ล่าสุด
║»» ป้องกันคนลบสมาชิกในกลุ่ม
║»» ป้องกันคนเปิดลิ้งกลุ่ม
║»» ป้องกันคนเชิญคนอื่นเข้ากลุ่ม
║»» ระบบตรวจสอบคนอ่าน
║»» ระบบแทคเรียกสมาชิก
║»» จัดตั้งแอดมิน+สต๊าฟได้
║»» หลายคน แบนคำพูดได้
║»» สามารถตั้งแบล็คลิสได้
║»══════════════
║»» บอทมี2ระดับครับ 650-1000บาท
║»» 
║»» ระดับแรก650บาทเหมาะสำหรับ
║»» แอดมินชวนสมาชิกเข้ากลุ่ม
║»» คนเดียว ไม่ได้แชร์ลิ้งกลุ่ม
║»» 
║»» ระดับ1000บาทเหมาะสำหรับ
║»» หาสมาชิก แชร์ลิ้งกลุ่มได้ ตั้ง
║»» แอดมินได้หลายคน
║»» ป้องกันบอทลบได้100%
║»══════════════
║» http://line.me/ti/p/~fbot999
╰═══ CREATOR: ©F - ʙᴏᴛʟɪɴᴇ™",
    "message":"บัญชีนี้ถูกป้องกันโดย 🖕F - ʙᴏᴛʟɪɴᴇ🖕 ระบบบล็อคคุณโดยอัตโนมัต",
    "comment":"""F - ʙᴏᴛʟɪɴᴇ
╭════════╬☠╬════════╮
     ╭═══════════════
║»» F - ʙᴏᴛʟɪɴᴇ
